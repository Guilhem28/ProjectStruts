            ...
            <div class="pull-out">
              <table id="ContactGrid" class="table table-striped datagrid m-b-small" >
                <thead>
                  ...
                  <tr>
	                  <th class="col col-lg-2">IDEntreprise</th>
	                  <th class="col col-lg-2">Name</th>
	                  <th class="col col-lg-2">address</th>
	                  <th class="col col-lg-3">Activity</th>          
		...
		<tbody>
				...
				<s:iterator value="entreprises">
					<tr class="col col-lg-12">
						...
						<td class="col col-lg-2"><s:property value="name" /></td>
						<td class="col col-lg-2"> <s:property value="adresse" /></td>
						<td class="col col-lg-3"><s:property value="secteurActivite" /></td>
						
			       	 	<s:url action="initUpdateEntrepriseAction.action" var="updateTag">
							<s:param name="id"> <s:property value="id"/> </s:param>		    
			       	 	</s:url>
			       		       	 	
			       	 	<td class="col col-lg-1"><a href="<s:property value="updateTag" />"><i class="icon-pencil"></i></a></td>
			       	 	
			       	 	<s:url action="deleteEntrepriseAction.action" var="deleteTag">
							<s:param name="id"> <s:property value="id"/> </s:param>		    
			       	 	</s:url>
